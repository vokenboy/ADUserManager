...
public partial class CreateUserDialog : Window
{
    ...
    private async Task LoadAvailableGroupsAsync(string filter)
    {
        ...
        catch (Exception ex)
        {
            ...
            _availableGroups.Clear();
            ErrorLogger.Log("Load group list", ex);
    ...
    private async void OnCreate(object sender, RoutedEventArgs e)
    {
        ...
        var request = new CreateUserRequest
        {
            ...
            SamAccountName = SamAccountNameBox.Text.Trim(),
            ...
            Enabled = true,
            ForcePasswordChangeAtNextLogon = true
        };

        var validationError = UserProvisioningService.ValidateRequest(request);
        ...
        try
        {
            ...
            var result = await _provisioningService.CreateUserAsync(request);
